...
private ["_queryResult","_query","_alias","_phoneNumberPlayer"];
...
_phoneNumberPlayer = [0600000001 + round(random 99999998)] call DB_fnc_numberSafe;

//Prepare the query statement..
_query = format ["INSERT INTO players (pid, name, cash, bankacc, aliases, cop_licenses, med_licenses, civ_licenses, civ_gear, cop_gear, med_gear, number) VALUES('%1', '%2', '%3', '%4', '%5','""[]""','""[]""','""[]""','""[]""','""[]""','""[]""','%6')",
    _uid,
    _name,
    _money,
    _bank,
