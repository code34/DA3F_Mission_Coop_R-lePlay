...
*       fn_NoCarbu_in_station.sqf
*
*/
/*
// Extract mission Altis life.

Original Author: NiiRoZz
...

{
    ...
    _pump addAction ["Mettre du carburant",{[1,"Les stations sont à sec !!!<br/>Vous devez vous organiser  avec la logistique de votre base pour obtenir du carburant"]call DA3F_fnc_hint},nil, 99, false, false, "", '_this distance _target < 5 && cursorObject isEqualTo _target'];
    //_pump addAction ["Mettre du carburant","",nil, 99, false, false, "", '_this distance _target < 5 && cursorObject isEqualTo _target'];
    false
