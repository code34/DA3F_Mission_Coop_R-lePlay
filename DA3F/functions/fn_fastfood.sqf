...
if (DA3F_Cash < _cash_Requis) exitWith {[1,format["Tu manque de cash.<br/>%1€", (DA3F_Cash - _cash_Requis)]]call DA3F_fnc_hint;};
	DA3F_Soif = DA3F_Soif + (10 + ceil(random 15));
	DA3F_Faim = DA3F_Faim + (10 + ceil(random 15));
	...
	[1,format["Vous venez de vous alimenter. Vous avez bu et mangé.<br/>Cela vous coûtes %1€",_cash_Requis]]call DA3F_fnc_hint;
};