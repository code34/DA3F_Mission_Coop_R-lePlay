...
class MCF_Checkbox
{
    ...
    tooltip = "Loto"; // Tooltip text
    tooltipColorShade[] = { 0, 0, 0, 1 }; // Tooltip background color
    tooltipColorText[] = { 1, 1, 1, 1 }; // Tooltip text color
    tooltipColorBox[] = { 1, 0.5, 0, 1 }; // Tooltip frame color
...
class MCF_RscControlsGroup {
	...
	class VScrollBar : MCF_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};

	class HScrollBar : MCF_RscScrollBar
	{
		height = 0.028;
	};
...
class MCF_RscControlsGroupNoScrollbars : MCF_RscControlsGroup {
...
class MCF_RscListNBox
{
	...
	idcLeft = -1;
	idcRight = -1;
	class ListScrollBar: MCF_RscScrollBar{};
	class ScrollBar: MCF_RscScrollBar{};
};
...
class MCF_RscTitle : MCF_RscText {
	style = 0;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
};

class MCF_RscPicture {
	shadow = 0;
	type = 0;
	style = 48;
	sizeEx = 0.023;
...
class MCF_RscTextMulti : MCF_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class MCF_RscPictureKeepAspect : MCF_RscPicture
{
	style = 0x30 + 0x800;
};

class MCF_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class MCF_RscButtonTextOnly : MCF_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class MCF_RscButtonMenu : MCF_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class MCF_RscShortcutButtonMain : MCF_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class MCF_RscButtonInvisibleByVoxid : MCF_RscButtonMenu {
...
class MCF_RscBackground : MCF_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class MCF_RscCombo {
	...
	class ComboScrollBar : MCF_RscScrollBar {};
};

class MCF_RscToolbox {
	colorText[] = {0.95, 0.95, 0.95, 1};
	color[] = {0.95, 0.95, 0.95, 1};
