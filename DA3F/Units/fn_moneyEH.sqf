...
private _MCF_WinCash 	= getNumber (missionConfigFile >> "DA3F_CfgMission" >> "DA3F_Infos" >> "DA3F_WinCash");
private _cash_Bonus 	= getNumber (missionConfigFile >> "DA3F_CfgMission" >> "DA3F_Infos" >> "cash_Bonus");
...
switch (true) do {
    case (_distance >= 0 && _distance <= 100 ): {_cash_Bonus = _cash_Bonus * (ceil (random 9));};
    case (_distance >= 100 && _distance <= 199 ): {_cash_Bonus = _cash_Bonus * 1};
    case (_distance >= 200 && _distance <= 299 ): {_cash_Bonus = _cash_Bonus * 2};
    case (_distance >= 300 && _distance <= 399 ): {_cash_Bonus = _cash_Bonus * 3};
    case (_distance >= 400 && _distance <= 499 ): {_cash_Bonus = _cash_Bonus * 4;};
    case (_distance >= 500 && _distance <= 599 ): {_cash_Bonus = _cash_Bonus * 5;};
    case (_distance >= 600 && _distance <= 699 ): {_cash_Bonus = _cash_Bonus * 6;};
    case (_distance >= 700 && _distance <= 799 ): {_cash_Bonus = _cash_Bonus * 7;};
    case (_distance >= 800 && _distance <= 899 ): {_cash_Bonus = _cash_Bonus * 8;};
    case (_distance >= 900 && _distance <= 999 ): {_cash_Bonus = _cash_Bonus * 9;};
    case (_distance >= 1000): {_cash_Bonus = _cash_Bonus * 10};
};
