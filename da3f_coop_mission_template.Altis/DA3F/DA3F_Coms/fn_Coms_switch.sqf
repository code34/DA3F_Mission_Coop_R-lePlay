...
private ["_type","_display","_txt_Msg","_txt_News","_valmsg","_Showmsg","_Editmsg","_ListUnits"];
    ...
    _ListUnits  = (_display displayCtrl 2100);
		...
		switch (_type) do {
		    ...
		    case 1: {
	            _txt_Msg ctrlSetStructuredText parseText format ["<t color='#FE0A26' underline='false' size='1.1' >Conversations<t/>", nil];
	            _txt_News ctrlSetStructuredText parseText format ["<t color='#00F700' underline='true' size='1.1' >Écrire un message<t/>", nil];
