...

{
    ...
    _pump addAction ["Mettre du carburant",{[1,"Les stations sont à sec !!!<br/>Vous devez organiser la logistique pour obtenir du carburant"]call DA3F_fnc_hint},nil, 99, false, false, "", '_this distance _target < 5 && cursorObject isEqualTo _target'];
